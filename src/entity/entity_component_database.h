...
namespace entler {
    ...
    public:
        ...
        void add_entity(Component<component_type_ids>... components) {
            ...
            Entity entity;
            entity.component_type_mask = make_component_type_mask<component_type_ids...>();
            entity.tombstone = 0;
    ...
    public:
        ...
        public:
            QueryRecord(EntityComponentDatabase& database)
                    : database_(database)
                    , removed_(false)
        ...
        class QueryResult {
        public:
            using Record = QueryRecord<component_type_ids...>;
